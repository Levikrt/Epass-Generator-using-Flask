...
import requests
account_sid = 'AC5c852f152cd021e132c3418faaa68be4'
auth_token = '21e89dda2efb385c35a28fb87b4fd210'
...
def registration_details():
    ...
    if travel_pass < 30 and request.method == 'POST':
        ...
        client.messages.create(from_='whatsapp:+14155238886',
                               to='whatsapp:+917995708499',
                               body="Hello " + " " + full_name + " " + "Your Travel From " + " " + source_dt + " " + "To" + " " + destination_dt + " "
                                      + "Has" + " " + status + " On" + " " + date + " ")

        return render_template('resgistrationdetails.html', var=full_name, var1=email_id, var2=id_proof,
